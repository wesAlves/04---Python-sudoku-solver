...
# print(len(my_sudoku_lines['line1']))
# print(len(my_sudoku_columns['column1']))


# for i in my_sudoku_lines:
#     print(i)

# for i in my_sudoku_columns:
#     print(i)
group_number = 0
line_number = 0
...
lines = my_sudoku_lines
columns = my_sudoku_columns
...
for line in lines:
    ...
    for i in range(len(lines[line])):
        ...
        for values in lines[line]:

            if lines[line][i] != values:

                banana = 'not equal'

print(banana)

# if my_sudoku_lines[line][group_number] == "Col1 row 1":

#     line_value = my_sudoku_lines[line][0]
#     print(my_sudoku_lines[line][0])

# for column in columns:

#     if columns[column][line_number] == line_value:
